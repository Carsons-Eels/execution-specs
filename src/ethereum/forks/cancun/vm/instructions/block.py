...
def block_hash(evm: Evm) -> None:
    ...
    Raises
    ------
    :py:class:`~ethereum.forks.cancun.vm.exceptions.StackUnderflowError`
        If `len(stack)` is less than `1`.
    :py:class:`~ethereum.forks.cancun.vm.exceptions.OutOfGasError`
    ...
    # GAS
    charge_gas(evm, gas.GAS_BLOCK_HASH)
...
def coinbase(evm: Evm) -> None:
    ...
    Raises
    ------
    :py:class:`~ethereum.forks.cancun.vm.exceptions.StackOverflowError`
